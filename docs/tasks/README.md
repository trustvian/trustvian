...
Active task specifications live here. A task file states one slice's
objective, scope, non-goals, technical requirements, tests, and acceptance
criteria, and is written before the work starts.
